...
ActiveRecord::Schema.define(version: 20160212201847) do
  ...
  add_index "events", ["creator_id", "date"], name: "index_events_on_creator_id_and_date", unique: true
  add_index "events", ["creator_id"], name: "index_events_on_creator_id"
  add_index "events", ["creator_id"], name: "index_events_on_date_and_creator_id", unique: true
